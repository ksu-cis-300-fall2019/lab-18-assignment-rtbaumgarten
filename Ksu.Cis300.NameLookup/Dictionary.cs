...
namespace Ksu.Cis300.NameLookup
{
    ...
    public class Dictionary<TKey, TValue> where TKey : IComparable<TKey>
    {
        ...
        /// <summary>
        /// This method returns the result of removing the node with the smallest key
        /// </summary>
        /// <param name="t"></param>
        ...
        /// <summary>
        /// This method returns the updated tree from removing the node
        /// </summary>
        ...
        private static BinaryTreeNode<KeyValuePair<TKey, TValue>> Remove(TKey key, BinaryTreeNode<KeyValuePair<TKey, TValue>> t, out bool removed)
        {
            ...
            if (comp == 0)
            {
                ...
                {
                    BinaryTreeNode<KeyValuePair<TKey, TValue>> newRight = RemoveMininumKey(t.RightChild, out KeyValuePair<TKey, TValue> min);
        ...
        /// <summary>
        /// This method returns wether the key was found within the tree
        /// </summary>
        /// <param name="k"></param>
        /// <returns></returns>
        ...
        {
            CheckKey(k);
            _elements = Remove(k, _elements, out bool b);
            return b;
        }
    }
}
